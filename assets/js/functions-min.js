!(function (t, e, i, n) {
	...
	function _(t, e) {
		var i = e.center,
			...
			s = t.prevDelta || {},
			r = t.prevInput || {};
		(e.eventType !== Pt && r.eventType !== Rt) || ((s = t.prevDelta = { x: r.deltaX || 0, y: r.deltaY || 0 }), (n = t.offsetDelta = { x: i.x, y: i.y })), (e.deltaX = s.x + (i.x - n.x)), (e.deltaY = s.y + (i.y - n.y));
	}
	function S(t, e) {
	...
	function b(t) {
		for (var e = [], i = 0; i < t.pointers.length; ) (e[i] = { clientX: vt(t.pointers[i].clientX), clientY: vt(t.pointers[i].clientY) }), i++;
		return { timeStamp: gt(), pointers: e, center: P(e), deltaX: t.deltaX, deltaY: t.deltaY };
	}
	function P(t) {
		var e = t.length;
	...
	l(Y, I, {
		handler: function De(t) {
			...
			e & Ot && 1 !== t.which && (e = Rt),
			this.pressed && (e & Rt && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: _t, srcEvent: t }));
		},
	});
	var Gt = { pointerdown: Pt, pointermove: Ot, pointerup: Rt, pointercancel: Mt, pointerout: Mt },
		Bt = { 2: At, 3: Dt, 4: _t, 5: St },
		Zt = "pointerdown",
		Jt = "pointermove pointerup pointercancel";
	t.MSPointerEvent && !t.PointerEvent && ((Zt = "MSPointerDown"), (Jt = "MSPointerMove MSPointerUp MSPointerCancel")),
		l(k, I, {
			handler: function _e(t) {
				...
				s & Pt && (0 === t.button || o) ? 0 > a && (e.push(t), (a = e.length - 1)) : s & (Rt | Mt) && (i = !0),
	...
	l(q, I, {
		handler: function Se(t) {
			...
			if ((e === Pt && (this.started = !0), this.started)) {
				...
				e & (Rt | Mt) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: At, srcEvent: t });
			}
		},
	});
	...
	l(W, I, {
		handler: function be(t) {
			var e = ee[t.type],
				i = H.call(this, t, e);
			i && this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: At, srcEvent: t });
		},
	});
	var ne = 2500,
		se = 25;
		...
		l(it, et, {
			...
			directionTest: function (t) {
				var e = this.options,
					...
					o = t.deltaY;
				return (
					s & e.direction || (e.direction & qt ? ((s = 0 === r ? zt : 0 > r ? Nt : Xt), (i = r != this.pX), (n = Math.abs(t.deltaX))) : ((s = 0 === o ? zt : 0 > o ? Yt : kt), (i = o != this.pY), (n = Math.abs(t.deltaY)))),
						(t.direction = s),
		...
		l(ot, et, {
			...
			attrTest: function (t) {
				var e = this.options.direction,
					i;
				return (
					e & (qt | Ft) ? (i = t.overallVelocity) : e & qt ? (i = t.overallVelocityX) : e & Ft && (i = t.overallVelocityY),
					this._super.attrTest.call(this, t) && e & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && mt(i) > this.options.velocity && t.eventType & Rt
				);
			},
			emit: function (t) {
		...
		function t(t) {
			...
			"swipeup" === t.type || 40 === t.keyCode || t > 0
				? s !== r
					? ((o = s + 1), e(o), i(s, o, r))
					: (e(o), i(s, o, r))
				: ("swipedown" === t.type || 38 === t.keyCode || 0 > t) && (0 !== s ? ((o = s - 1), e(o), i(s, o, r)) : ((o = r), e(o), i(s, o, r)));
		}
		function e(t) {
		...
		function n() {
			$(".header--nav-toggle").click(function () {
				...
				$(".burger-button").click(function () {
					$(".outer-nav, .outer-nav li, .outer-nav--return").addClass("is-vis");
					$(".burger-content").addClass("visibleContent");
				}),
				$(".outer-nav--return, .outer-nav li").click(function () {
					...
					$(".burger-content").removeClass("visibleContent");
				});
		}
		function s() {
